...
...                 Run "robot -d Results --variable BROWSER:ff test/Pomona.robot" to run in firefox browser
...                 Run "robot -d Results --variable BROWSER:gc test/Pomona.robot" to run in chrome browser
...                 Run "robot -d Results --variable BROWSER:edge test/Pomona.robot" to run in edge browser
...                 Run "robot -d Results --variable BROWSER:ie test/Pomona.robot" to run in internet explorer browser
...
User Select second available product and add to cart with quantity as 2.
    [Tags]  Amazon
